...
Versions:<br>
&emsp;Version 0.1:<br>
&emsp;&emsp;Description: Create a fresh linux Virtual Machine installation, and with little to no user input achieve ansible.builtin.ping = pong<br>
&emsp;&emsp;Status: Incomplete<br>
&emsp;Version 0.2:<br>
&emsp;&emsp;Description: Create a fresh windows Virtual Machine installation, and with little to no user input achieve ansible.builtin.ping = pong<br>
&emsp;&emsp;Status: incomplete<br>
